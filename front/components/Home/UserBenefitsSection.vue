<template>
  <section class="user-benefits-section py-8 sm:py-12 bg-gray-50">
    <div class="max-w-xl sm:max-w-3xl md:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <h2 class="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-8 sm:mb-12 text-center">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <!-- Image -->
          <img class="h-12 w-12 sm:h-16 sm:w-16 mb-3" src="/icons/employees.svg" alt="Avantages pour les employés">
