<template>
  <aside class="sidebar lg:w-64 bg-white">
    <nav
      class="flex lg:flex-col items-center justify-center sticky top-1/2 lg:top-[62px] -translate-y-1/2 lg:translate-y-0 overflow-x-auto lg:overflow-x-hidden"
    >
