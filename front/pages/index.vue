...
<template>
  <section class="w-100">
    <HomeWritableContent class="min-h-[300px] bg-blue-50 border-b">
      <h1 class="h1 italic text-7xl font-bold mt-10 mb-3">Time Manager</h1>
      <span class="italic text-lg ml-3">
        The new app to manage your employees working time
      </span>
    </HomeWritableContent>
    <HomeWritableContent class="bg-gray-50">
      <p>
